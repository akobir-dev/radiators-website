  ...
  return (
    <>
      <main className="container mt-[90px]">
        <section className="bg-[#fff] h-auto p-[40px] flex flex-col lg:flex-row items-start gap-[30px] lg:gap-[50px] shadow-lg">
          <h1 className="text-[#4B4B4B] text-[44px] font-[500] lg:hidden">
            {data.name}
          </h1>
          <div className="w-[100%] lg:max-w-[40%] h-[400px] sm:h-[600px] lg:h-[700px] relative rounded-[5px] overflow-hidden">
        ...
        <section className="bg-[#fff] h-auto p-[30px] gap-[30px] my-[90px] shadow-lg">
