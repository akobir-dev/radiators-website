  ...
  return (
    <>
      ...
      <main className="container">
        <section className="bg-[#fff] mb-[50px] p-[40px]">
          <div className="flex items-center gap-[30px] mb-[30px]">
            <button
              className={`text-[25px] md:text-[36px] font-[500]${activeTab === "delivery"
            ...
            <button
              className={`text-[25px] md:text-[36px] font-[500]${activeTab === "payment"
                ? "text-[#3A8F34] underline"
                : "text-[#939393]"
                }`}
              onClick={() => {
